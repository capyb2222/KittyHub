...
-- Compatibility layer for cross-executor support
...
-- Debug: show a text overlay so the user knows the script is alive
if hasDrawing then
...
local function UpdateSpectatorList()
    ...
    for _, key in ipairs(labelKeys) do
        if not tableFind(specs, key) then
